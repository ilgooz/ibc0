...
import (
	...
	appparams "github.com/test/ibc0/app/params"
	"github.com/test/ibc0/x/ibc0"
	ibc0keeper "github.com/test/ibc0/x/ibc0/keeper"
	ibc0types "github.com/test/ibc0/x/ibc0/types"
)

var (
	// DefaultNodeHome default home directories for the application daemon
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/ibc0d")
	}
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
        ...
        stakingtypes.StoreKey, slashingtypes.StoreKey, evidencetypes.StoreKey,
        ibctransfertypes.StoreKey, capabilitytypes.StoreKey, distrtypes.StoreKey,
        ibchost.StoreKey, ibc0types.StoreKey,
	)
	...
	app.ibc0Keeper = *ibc0keeper.NewKeeper(
        appCodec, keys[ibc0types.StoreKey], keys[ibc0types.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
        ...
        transferModule,
		ibc0.NewAppModule(appCodec, app.ibc0Keeper),
	)
	...
	app.mm.SetOrderInitGenesis(
        ...
        ibctransfertypes.ModuleName, ibc0types.ModuleName,
	)
